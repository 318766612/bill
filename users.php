                ...
                <div class="record_form" id="system">
                    <form id="system_form" name="system_form" method="post" onsubmit="return checkpost('system',this);">
                        ...
                        foreach ($arr[1] as $k => $v) {
                            if ($v == 'DB_NAME' or $v == 'TABLE') {
                                continue;
                            }
                            if ($v == 'Multiuser') {
                                ?>
                                <p><i><?php echo $keyinfo[$v]; ?>：</i><label class="red"><input name="Multiuser"
                                                                                                type="radio"
                                                                                                value="1" <?php if ($arr[2][$k] == '1') {
                                            echo "checked";
                                        } ?> />开启</label><label class="ml10"><input name="Multiuser" type="radio"
                                                                                    value="0" <?php if ($arr[2][$k] == '0') {
                                            echo "checked";
                                        } ?> />关闭</label></p>
                            <?php } else {
                                ?>
                                <p><i><?php echo $keyinfo[$v]; ?>：</i><input type="text" class="w180"
                                                                             name="<?php echo $v; ?>"
                                                                             id="<?php echo $v; ?>"
                                                                             value="<?php echo $arr[2][$k]; ?>"></p>
                            <?php }
                        } ?>
                        <p class="btn_div">
...
/*                            } else {
    ...
    <table width="100%" border="0" align="left" cellpadding="5" cellspacing="1" bgcolor='#B3B3B3'
           class='table table-striped table-bordered'>
        <tr>
