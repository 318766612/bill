        ...
        <tr>
            <td bgcolor="#FFFFFF">
                <div class="form-group block mt20">
                    <div class="col-sm-10">
                        <input type="button" class="btn btn-primary" id="exportCSV" value="导出全部记账CSV"
                               onClick="window.location.href='date.php?action=export'">
                    </div>
                </div>
                <hr/>
                <form id="import_form" class="block" action="old/date.php?action=import" method="post"
                    ...
                    <div class="form-group">
                        <div class="col-sm-8">
                            <label class="pull-right"><input type="submit" class="btn btn-danger ml5"
                                                             value="导入CSV"></label>
